...
help:
	...
	@echo "  make monitor-down       # Stop monitoring stack (preserves volumes)"
	@echo "  make monitor-clean      # Stop monitoring stack and remove volumes"
